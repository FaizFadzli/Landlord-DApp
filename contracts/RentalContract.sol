...
contract RentalContract /* is ReentrancyGuard */ {
    ...
    event DebugValues(address tenant, uint256 rent, uint256 duration);
    ...
    function createLease(
        ...
        emit DebugValues(_tenant, _rentAmount, _durationMonths); // 👈 Add this
    ...
    function payRent(uint256 leaseId) external payable onlyTenant(leaseId) {
        Lease storage lease = leases[leaseId];
